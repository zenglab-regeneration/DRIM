...
Planarian_run<-function(){
  ...
  source_python("/code/sc_st_gene_charge.py")
  print("start spot_pre")
  source_python("/code/spot_pre.py")
  print("start GS_mapping_HVG_gene")
  source_python("/code/GS_mapping_HVG_gene.py")
  print("start newRegineGrowing_use_RG")
  source_python("/code/newRegineGrowing_use_RG.py")
  print("start comb_mapping_spot")
  source_python("/code/comb_mapping_spot.py")
  print("start it_final_celltype")
  source_python("/code/it_final_celltype.py")
  setwd(now_path)
  print("end")
}
